return {
    ...
    keys = {
        ...
        { "<leader>f*", "<cmd> Telescope current_buffer_fuzzy_find <cr>", desc = 'Telescope current buffer fuzzy find', noremap = true },
        -- Git
        ...
        -- Lsp
        { "<localleader>dS", "<cmd> Telescope lsp_document_symbols <cr>", desc = 'Telescope lsp document symbols', noremap = true },
        ...
        { "<leader>gi", "<cmd> Telescope lsp_implementions <cr>", desc = 'Telescope lsp implementions', noremap = true },
        -- Other
        { "<localleader>rg", "<cmd> Telescope registers <cr>", desc = 'Telescope registers', noremap = true },
        { "<A-s>", "<cmd> Telescope spell_suggest <cr>", mode = { "n", "i", "v" }, desc = 'Telescope spell suggest', noremap = true },
    },
}
