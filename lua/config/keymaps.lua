...
vim.api.nvim_set_keymap('n', '<localleader>bg', '<cmd> lua SetBackground.OtherTheme.transparency.toggle() <cr>',
    { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<localleader>st", "<cmd> lua SwitchTheme.switch() <cr>", { noremap = true, silent = true })
